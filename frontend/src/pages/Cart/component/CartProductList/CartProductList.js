        ...
        },
        {
            ...
            render: () => (
                <Space className={cx('cart-product-list__space-remove-header')}>
                  <Link className={cx('cart-product-list__space-remove-content')} to="/">X</Link>
                </Space>
              ),
            },
      ];      
    return <div className={cx('cart-product-list')}><Table columns={columns} dataSource={data} /></div>;
}
